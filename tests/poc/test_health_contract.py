"""Lead-owned acceptance checks, written before local implementation."""
import http.client
...
class HealthContract(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        spec = importlib.util.spec_from_file_location('poc_health', path)
    ...
    def test_unknown_query_and_trailing_slash(self):
